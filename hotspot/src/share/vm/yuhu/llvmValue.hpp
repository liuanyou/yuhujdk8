...
#ifndef SHARE_VM_YUHU_LLVMVALUE_HPP
#define SHARE_VM_YUHU_LLVMVALUE_HPP
...
class LLVMValue : public AllStatic {
 public:
  ...
  {
    return llvm::ConstantInt::get(YuhuType::jbyte_type(), value, true);
  }
  static llvm::ConstantInt* jint_constant(jint value)
  {
    return llvm::ConstantInt::get(YuhuType::jint_type(), value, true);
  }
  static llvm::ConstantInt* jlong_constant(jlong value)
  {
    return llvm::ConstantInt::get(YuhuType::jlong_type(), value, true);
  }
  static llvm::ConstantFP* jfloat_constant(jfloat value)
  {
    return llvm::ConstantFP::get(YuhuContext::current(), llvm::APFloat(value));
  }
  ...
  {
    return llvm::ConstantPointerNull::get(YuhuType::klass_type());
  }

 public:
  static llvm::ConstantInt* bit_constant(int value)
  {
    return llvm::ConstantInt::get(YuhuType::bit_type(), value, false);
  }
  static llvm::ConstantInt* intptr_constant(intptr_t value)
  {
    return llvm::ConstantInt::get(YuhuType::intptr_type(), value, false);
  }
};

#endif // SHARE_VM_YUHU_LLVMVALUE_HPP
