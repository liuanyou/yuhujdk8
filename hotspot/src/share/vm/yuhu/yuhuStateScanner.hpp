...
#ifndef SHARE_VM_YUHU_YUHUSTATESCANNER_HPP
#define SHARE_VM_YUHU_YUHUSTATESCANNER_HPP
...
class YuhuStateScanner : public YuhuTargetInvariants {
 ...
 protected:
  ...
  virtual void process_stack_slot(int index, YuhuValue** value, int offset) {}
  ...
  // Integrity checks
 private:
  void stack_integrity_checks(YuhuState* state) PRODUCT_RETURN;
  void locals_integrity_checks(YuhuState* state) PRODUCT_RETURN;
};

#endif // SHARE_VM_YUHU_YUHUSTATESCANNER_HPP
