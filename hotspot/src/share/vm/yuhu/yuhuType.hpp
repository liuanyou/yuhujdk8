...
#ifndef SHARE_VM_YUHU_YUHUTYPE_HPP
#define SHARE_VM_YUHU_YUHUTYPE_HPP
...
class YuhuType : public AllStatic {
 private:
  static YuhuContext& context() {
    return YuhuContext::current();
  }
...
#endif // SHARE_VM_YUHU_YUHUTYPE_HPP
