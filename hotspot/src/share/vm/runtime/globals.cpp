...
#ifdef YUHU
#define YUHU_PRODUCT_FLAG_STRUCT(       type, name, value, doc) { #type, XSTR(name), &name,      NOT_PRODUCT_ARG(doc) Flag::Flags(Flag::DEFAULT | Flag::KIND_YUHU | Flag::KIND_PRODUCT) },
#define YUHU_PD_PRODUCT_FLAG_STRUCT(    type, name, value, doc) { #type, XSTR(name), &name,      NOT_PRODUCT_ARG(doc) Flag::Flags(Flag::DEFAULT | Flag::KIND_YUHU | Flag::KIND_PRODUCT | Flag::KIND_PLATFORM_DEPENDENT) },
#define YUHU_DIAGNOSTIC_FLAG_STRUCT(    type, name, value, doc) { #type, XSTR(name), &name,      NOT_PRODUCT_ARG(doc) Flag::Flags(Flag::DEFAULT | Flag::KIND_YUHU | Flag::KIND_DIAGNOSTIC) },
#define YUHU_DEVELOP_FLAG_STRUCT(       type, name, value, doc) { #type, XSTR(name), NAME(name), NOT_PRODUCT_ARG(doc) Flag::Flags(Flag::DEFAULT | Flag::KIND_YUHU | Flag::KIND_DEVELOP) },
#define YUHU_PD_DEVELOP_FLAG_STRUCT(    type, name, value, doc) { #type, XSTR(name), NAME(name), NOT_PRODUCT_ARG(doc) Flag::Flags(Flag::DEFAULT | Flag::KIND_YUHU | Flag::KIND_DEVELOP | Flag::KIND_PLATFORM_DEPENDENT) },
#define YUHU_NOTPRODUCT_FLAG_STRUCT(    type, name, value, doc) { #type, XSTR(name), NAME(name), NOT_PRODUCT_ARG(doc) Flag::Flags(Flag::DEFAULT | Flag::KIND_YUHU | Flag::KIND_NOT_PRODUCT) },
#endif
...
#endif
#ifdef YUHU
 YUHU_FLAGS(YUHU_DEVELOP_FLAG_STRUCT, YUHU_PD_DEVELOP_FLAG_STRUCT, YUHU_PRODUCT_FLAG_STRUCT, YUHU_PD_PRODUCT_FLAG_STRUCT, YUHU_DIAGNOSTIC_FLAG_STRUCT, YUHU_NOTPRODUCT_FLAG_STRUCT)
#endif
